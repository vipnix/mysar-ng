<nobr>[
<a href="{$smarty.server.PHP_SELF}?a=allsites&date={$pageVars.today}">&lt;&lt;&lt; Retour au r&eacute; pour un jour sp&eacute;cifique"</a>
|
Retour "Rapport des utilisateurs et collaborateur pour un jour donn&eacute;e
