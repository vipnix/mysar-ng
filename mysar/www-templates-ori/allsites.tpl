<nobr>[
<a href="./?a=IPSummary&date={$pageVars.date}">&lt;&lt;&lt; Back to "Hosts and Users Summary for a Specific Day"</a>
|
...
<table>
  ...
  <a href="./?a={$pageVars.thisPage}&date={$pageVars.today}">[ Go to today ]</a>
  </td></tr>
  </table>
  <p>
      [
  ...
  <tr onMouseOver="this.bgColor='#C5D3E7';" onMouseOut="this.bgColor='#DAE3F0';">
    <td><a href="./?a=siteusers&sitesID={$record.sitesID}&date={$pageVars.date}"><b>Details</b></a></td>
