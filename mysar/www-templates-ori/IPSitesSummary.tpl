<nobr>[
<a href="./?a=IPSummary&date={$pageVars.today}">&lt;&lt;&lt; Back to "Hosts and Users Summary for a Specific Day"</a>
|
...
<table>
  ...
  <tr><td style="text-align:center;">
    <a href="./?a={$pageVars.thisPage}&hostiplong={$pageVars.hostiplong}&date={$pageVars.today}&usersID={$pageVars.usersID}">[ Go to today ]</a>
  </td></tr>
</table>
<p>
<table>
