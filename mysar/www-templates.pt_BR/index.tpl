<center>
<nobr>[<a href="{$pageVars.uri}">Atualizar esta página</a>]</nobr>
</center>
...
<table cellpadding=1 cellspacing=1>
    <tr>
        ...
        <th rowspan="2">
            ...
            {$pageVars.usersLabelStart|default:''}USUÁRIOS{$pageVars.usersLabelEnd|default:''}
        ...
        <th rowspan="2">
            ...
            {$pageVars.hostsLabelStart|default:''}ESTAÇÕES{$pageVars.hostsLabelEnd|default:''}
