...
<div class="table-responsive"><table class="table table-condensed">
  ...
  <div class="table-responsive"><table class="table table-condensed">
    <tr>
      ...
      <th>
        <a href="{$smarty.server.PHP_SELF}?{$pageVars.url.usersASC}"><img border="{$pageVars.usersASCImageBorder}" src="images/up-arrow.gif" class="img-with-border"></a>
          {$pageVars.usersLabelStart}USU&Aacute;RIOS{$pageVars.usersLabelEnd}
        <a href="{$smarty.server.PHP_SELF}?{$pageVars.url.usersDESC}"><img border="{$pageVars.usersDESCImageBorder}" src="images/down-arrow.gif" class="img-with-border"></a>
      </th>
      <th>
        <a href="{$smarty.server.PHP_SELF}?{$pageVars.url.hostsASC}"><img border="{$pageVars.hostsASCImageBorder}" src="images/up-arrow.gif" class="img-with-border"></a>
          {$pageVars.hostsLabelStart}ESTA&Ccedil;&Otilde;ES{$pageVars.hostsLabelEnd}
        <a href="{$smarty.server.PHP_SELF}?{$pageVars.url.hostsDESC}"><img border="{$pageVars.hostsDESCImageBorder}" src="images/down-arrow.gif" class="img-with-border"></a>
      </th>
      <th>
