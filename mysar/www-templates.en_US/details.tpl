<center>
<nobr>[
<a href="{$smarty.server.PHP_SELF}?a=IPSitesSummary&date={$pageVars.date}&hostiplong={$pageVars.hostiplong}&usersID={$pageVars.usersID}"><<< Back to "Report for a Specific Station and Date"</a>
|
...
<div class="table-responsive">
    <table class="table table-condensed">
        <tr>
            <th style="font-size: 20px">Details of Station, User, Date, and Site</th>
        </tr>
    </table>
</div>
...
<div class="table-responsive">
    <table class="table table-condensed">
        ...
        <tr>
            <td style="width: 30%; text-align: left;">Station</td>
            <td style="width: 70%; text-align: left;">{$pageVars.host.hostname}</td>
        </tr>
        <tr>
            <td style="width: 30%; text-align: left;">Station IP</td>
            <td style="width: 70%; text-align: left;">{$pageVars.host.ip}</td>
        </tr>
        <tr>
            <td style="width: 30%; text-align: left;">Station Description</td>
    ...
    <table class="table table-condensed" style="width: 100%;">
        <tr>
            <th style="width: 20%; text-align: center;">
                ...
                {$pageVars.timeLabelStart|default:''}TIME{$pageVars.timeLabelEnd|default:''}
