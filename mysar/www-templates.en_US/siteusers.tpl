<nobr>[
<a href="./?a=allsites&date={$pageVars.today}">&lt;&lt;&lt; Back to "Sites Summary for a Specific Day"</a>
|
<a href="{$pageVars.uri}">Refresh this page</a>
]</nobr>

  <table><tr><th style="font-size: 20px";>Hosts and Users Summary for a Specific Site and Date</th></tr></table>
<p>
<table>
