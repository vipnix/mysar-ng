...
<a href="{$pageVars.uri}">Refresh this page</a>
  ...
  <div class="table-responsive"><table class="table table-condensed"><tr><th style="font-size: 20px";>Hosts and Users Summary for a Specific Site and Date</th></tr></table></div>
<p>
