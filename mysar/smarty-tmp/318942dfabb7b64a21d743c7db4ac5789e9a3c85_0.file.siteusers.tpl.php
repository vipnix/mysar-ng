<?php
/* Smarty version 3.1.34-dev-7, created on 2025-04-28 06:45:24
  from '/srv/www/htdocs/mysar/www-templates.pt_BR/siteusers.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_680f4e34b26764_68793461',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '318942dfabb7b64a21d743c7db4ac5789e9a3c85' => 
    array (
      0 => '/srv/www/htdocs/mysar/www-templates.pt_BR/siteusers.tpl',
      1 => 1745833522,
      2 => 'file',
    ),
  ),
...
function content_680f4e34b26764_68793461 (Smarty_Internal_Template $_smarty_tpl) {
?><center>
<nobr>[
<a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=allsites&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['date'];?>
"><<< Voltar para Relação de Acessos de um dia</a>
|
    ...
    <table class="table table-condensed">
        <tr>
            <td style="text-align: center;">
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=siteusers&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['previousWeek'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
" title="Voltar 1 Semana"><<</a>
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=siteusers&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['previousDate'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
" title="Voltar 1 Dia"><</a>
                <?php echo $_smarty_tpl->tpl_vars['pageVars']->value['thisDateFormatted'];?>

                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=siteusers&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['nextDate'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
" title="Avançar 1 Dia">></a>
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=siteusers&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['nextWeek'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
" title="Avançar 1 Semana">>></a>
        ...
        <tr>
            <td style="text-align: center;">
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?a=siteusers&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['today'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
    ...
    <table class="table table-condensed" style="width: 100%;">
        <tr>
            ...
            <th style="width: 35%; text-align: center;">
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['url']['hostipASC'])===null||$tmp==='' ? '0' : $tmp);?>
">
...
" src="images/up-arrow.gif" class="img-with-border">
                ...
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['hostipLabelStart'])===null||$tmp==='' ? '0' : $tmp);?>
ESTAÇÃO<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['hostipLabelEnd'])===null||$tmp==='' ? '0' : $tmp);?>

                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['url']['hostipDESC'])===null||$tmp==='' ? '0' : $tmp);?>
">
...
" src="images/down-arrow.gif" class="img-with-border">
            ...
            <th style="width: 35%; text-align: center;">
                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['url']['usernameASC'])===null||$tmp==='' ? '0' : $tmp);?>
">
                    <img border="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['usernameASCImageBorder'])===null||$tmp==='' ? '0' : $tmp);?>
" src="images/up-arrow.gif" class="img-with-border">
                </a>
                <?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['usernameLabelStart'])===null||$tmp==='' ? '0' : $tmp);?>
USUÁRIO<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['usernameLabelEnd'])===null||$tmp==='' ? '0' : $tmp);?>

                <a href="<?php echo $_SERVER['PHP_SELF'];?>
?<?php echo (($tmp = @$_smarty_tpl->tpl_vars['pageVars']->value['url']['usernameDESC'])===null||$tmp==='' ? '0' : $tmp);?>
">
...
" src="images/down-arrow.gif" class="img-with-border">
        ...
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pageVars']->value['siteusers'], 'record');
if ($_from !== null) {
...
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
'><b>Detalhes</b></a></td>
                <td style="width: 35%; text-align: left;"><a href='<?php echo $_SERVER['PHP_SELF'];?>
?a=details&date=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['date'];?>
&hostiplong=<?php echo $_smarty_tpl->tpl_vars['record']->value['hostiplong'];?>
&usersID=<?php echo $_smarty_tpl->tpl_vars['record']->value['usersID'];?>
&sitesID=<?php echo $_smarty_tpl->tpl_vars['pageVars']->value['sitesID'];?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <tr>
            ...
            <th style="width: 35%; text-align: right;"><?php echo $_smarty_tpl->tpl_vars['pageVars']->value['distinctValues']['users'];?>
</th>
...
<div class="table-responsive" style="margin-top: 2rem;">
    <table class="table table-condensed" style="width: 100%;">
        ...
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['pageVars']->value['latestSiteActivity'], 'record');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['record']->value) {
?>
            <tr onMouseOver="this.bgColor='#C5D3E7';" onMouseOut="this.bgColor='#DAE3F0';">
